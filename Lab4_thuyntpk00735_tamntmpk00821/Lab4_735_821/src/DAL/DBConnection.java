...
public class DBConnection {
    //Tạo chuỗi kết nối
//    String connectionString = "jdbc:sqlserver://DESKTOP-BMLOLA4\\YUUKI;" 
//            + "databaseName=SimpleProductDB; user=sa; password=123456;";
    
//    
//     String connectionString = "jdbc:sqlserver://HUYNHAN\\HUYNHAN;" 
//           + "databaseName=SimpleProductDB; user=sa; password=123456;";
    
     
       String connectionString =  "jdbc:sqlserver://V5PV4SWQRRKBKF8\\SQL;"
             //bản SQL thường là :1433; bản SQL express --> \\SqlExpress
           + "databaseName=SimpleProductDB;user = sa;password = 123456;";
